...
(function(app) {
  ...
  function initItems() {
    ...
    products[1] = new bikeStore.Models.Item({
      ...
      quantity: 1,
      totalPrice: 400,
      description: 'The tires are narrow, high-pressure, and smooth to decrease' +
        ' rolling resistance. The bicycle is of a lightweight' +
        ' construction.',
    ...
    products[2] = new bikeStore.Models.Item({
      ...
      quantity: 1,
      totalPrice: 500,
      description: 'This road bike is most commonly used for commuting, urban and' +
        ' fitness riding. This combination provides a light, fast bike' +
        ' with a more upright and neutral riding.',
    ...
    products[3] = new bikeStore.Models.Item({
      ...
      quantity: 1,
      totalPrice: 600,
      description: 'One person steers while the other 6 pedal (or not) as the bike' +
        ' moves effortlessly along. More than 300 ConferenceBikes are now' +
        ' being enjoyed by a wide variety of groups in 18 countries.',
